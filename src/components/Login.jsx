      ...
      <form onSubmit={onSubmitHandler} onClick={(e)=> e.stopPropagation()} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] rounded-lg shadow-xl border border-gray-200 bg-white">
        ...
        <div className="w-full ">
          ...
          <input
            ...
            value={email}
            placeholder="type here"
            className="border border-gray-200 rounded w-full p-2 mt-1 outline-text-primay"
            type="email"
            required
          />
        </div>
        <div className="w-full ">
          ...
          <input
            ...
            value={password}
            placeholder="type here"
            className="border border-gray-200 rounded w-full p-2 mt-1 outline-text-primary"
            type="password"
            required
          />
        </div>
